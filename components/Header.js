      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center py-6 md:justify-start md:space-x-10">
          ...
          <div className="-mr-2 -my-2 md:hidden">
            <Popover.Button className="bg-white dark:bg-black rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-brand-500">
                ...
                <>
                  <Popover.Button
                    className={classNames(
                      ...
                      'group bg-white dark:bg-black rounded-md inline-flex items-center text-base font-medium hover:text-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500'
                    )}
                  >
                    <span>Solutions</span>
                    <ChevronDownIcon
                  ...
                  >
                    <Popover.Panel className="absolute z-20 -ml-4 mt-3 px-2 w-screen sm:px-0 lg:ml-0 lg:left-0">
                      <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                        <div className="relative grid gap-6 bg-white dark:bg-black px-5 py-6 sm:gap-8 sm:p-8">
                          {solutions.map((item) => (
                            ...
                            >
                              <item.icon className="flex-shrink-0 h-6 w-6 text-brand-600" aria-hidden="true" />
                              <div className="ml-4">
                        ...
                        <div className="px-5 py-5 bg-gray-50 space-y-6 sm:flex sm:space-y-0 sm:space-x-10 sm:px-8">
                          {callsToAction.map((item) => (
                            <div key={item.name} className="flow-root">
                              <a
                                href={item.href}
                                className="-m-3 p-3 flex items-center rounded-md text-base font-medium text-gray-600 hover:bg-gray-100"
                              >
              ...
              {({ open }) => (
                <>
                  ...
                  <Transition
                    ...
                    leaveTo="opacity-0 translate-y-1"
                  >
                    <Popover.Panel className="absolute z-20 left-0 mt-3 px-2 w-screen sm:px-0">
                      <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                        <div className="relative grid gap-6 bg-white dark:bg-black px-5 py-6 sm:gap-8 sm:p-8">
                          {resources.map((item) => (
                            <a
          ...
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            <a href="https://app.devonsean.com/signin.php" className="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">
              Sign in
            </a>
            <a
              href="https://app.devonsean.com/signup.php"
              className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-brand-600 hover:bg-brand-700"
            >
              Sign up
            </a>
          </div>
          ...
          <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white dark:bg-black divide-y-2 divide-gray-50">
            ...
            <div className="py-6 px-5 space-y-6">
              <div className="grid grid-cols-2 gap-y-4 gap-x-8">
                <a href="#" className="text-base font-medium text-gray-600 hover:text-gray-700">
                  Pricing
                </a>
